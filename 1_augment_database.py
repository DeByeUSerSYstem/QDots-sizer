...
# a collection of xy simulated files (eventually generated by Debussy
# https://debyeusersystem.github.io/) or experimental datasets namely
# diffractograms to be subjected to augmentation.
...
# folder containing all the initial diffractograms
args = parse_args()
    ...
    for solv_name, Y_solv, auc_solv in zip(solvents_tag, solvents_Y, solvents_auc):
        for nc_ratio in dilutions:
            ...
            fpath_normed_sum = os.path.join(diluted_files_dir,
                                            f'{basename}_Solv{solv_name}_Conc{nc_ratio}.int')
...
for lvl in noise_levels:
    ...
    for file in os.listdir(diluted_files_dir):
        if f'_noisy' in file:
            ...
            shutil.move(noise_path, noised_files_dir)
